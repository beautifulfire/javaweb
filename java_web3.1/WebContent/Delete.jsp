...
<title>删除</title>
<style>
.e{background-image:url(image/4.jpg)}
table {
...
<body class="e">
<%
		String de = (String)session.getAttribute("des");
		String id="";
		String question="";
		String answ1="";
		String answ2="";
	...
	<h1 align="center">	请再次确认你要删除的试题</h1>
	<table border="1" width="100%">
		...
		<input type="submit" name="send" value="删除"/>
	</form>	
</body>
</html>